        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    -->
                    <a href="addUser.php" class="nav-item nav-link"><i class="bi bi-person-bounding-box me-2"></i>Cadastro</a>
                    <a href="addReserva.php" class="nav-item nav-link"><i class="bi bi-cart-check me-2"></i>Reserva</a>
                    <a href="addClient.php" class="nav-item nav-link"><i class="bi bi-person-vcard me-2"></i>Clientes</a>
                    <a href="addResp.php" class="nav-item nav-link"><i class="bi bi-briefcase me-2"></i>Responsáveis</a>
                    <a href="addArea.php" class="nav-item nav-link"><i class="bi bi-building-add me-2"></i></i>Áreas</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
